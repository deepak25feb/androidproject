...
public class MainActivity extends AppCompatActivity {
    ...
    private void setOnboardingItems(){
        ...
        onboardingItem.add(new OnboardingItem(R.drawable.image1));
        onboardingItem.add(new OnboardingItem(R.drawable.image2));
        onboardingItem.add(new OnboardingItem(R.drawable.image3));
